      ...
      meta mustEqual MediaMetadata(
        ...
        Seq(
          MediaStream(
            ...
            Some(1280),
            Some("yuv420p"),
            Map("handler_name"->"WowzaStreamingEngine","creation_time"->"2019-01-22 15:17:42","language"->"eng","encoder"->"WowzaStreamingEngine"),
            Some("25/1"),
            Some(0.000000),
            Some("1/90000"),
            Some("avc1"),
          ...
          MediaStream(
            ...
            None,
            None,
            Map("handler_name"->"WowzaStreamingEngine","creation_time"->"2019-01-22 15:17:42","language"->"eng"),
            Some("0/0"),
            Some(0.000),
            Some("1/90000"),
            Some("mp4a"),
