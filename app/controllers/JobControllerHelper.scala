...
object JobControllerHelper {
  ...
  def updateProxyRef(report:JobReportSuccess, archiveEntry:ArchiveEntry, proxyLocationDAO:ProxyLocationDAO)(implicit s3Client:AmazonS3, dynamoClient:DynamoClient, ec:ExecutionContext) = ProxyLocation
