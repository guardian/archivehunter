...
trait AdminsOnly extends Circe {
  ...
  /**
    ...
    */
  def adminsOnlyAsync[A](request: UserRequest[A], allowHmac:Boolean=false)(block: Option[UserProfile]=>Future[Result])(implicit ec:ExecutionContext) = {
